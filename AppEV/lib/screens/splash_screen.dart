...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget _buildBackground() {
    return Stack(
      fit: StackFit.expand,
      children: [
        // ── HERO PHOTO ── full-bleed EV-and-charger photo behind everything.
        // Falls back to the original gradient if the asset fails to load.
        Image.asset(
        ...
        // ── Dark scrim ── tones the photo down so the animated EV scene
        // + brand text remain the focal point on top.
        Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              begin: Alignment.topCenter,
              ...
              colors: [
                Color(0x3312263C),  // ~20% top — photo nearly raw here
                Color(0x1A0A1628),  // ~10% middle — fully readable image
                Color(0x99060B18),  // ~60% bottom — text legibility only
              ],
              stops: [0.0, 0.5, 1.0],
            ),
          ),
        ),
        // Existing animated layers stay on top.
        CustomPaint(
          size: Size.infinite,
